import { A as A$1, i as i$2, _ as _decorate, s as s$1, x as x$1 } from './lit-element-134c12fd.js';
...
import { e } from './directive-helpers-b1abf1a2.js';
  ...
  return {
    ...
    d: [{
      ...
      value: function render() {
        var _this$word$split;
        const delayTime = this.duration / (this.word.length * 2.5);
        return x$1`
      ${(_this$word$split = this.word.split('')) === null || _this$word$split === void 0 ? void 0 : _this$word$split.map((letter, i) => x$1`<span
            class="letter"
            ${$({
          keyframeOptions: {
            delay: i * delayTime
