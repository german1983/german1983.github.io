import { i as i$1, _ as _decorate, s as s$1, x as x$1 } from './lit-element-134c12fd.js';
  ...
  return {
    ...
    d: [{
      ...
      function getMetaConfig() {
        ...
        return import('./grid-js.config-e1c16763.js').then(({
          config
        }) => {
          return config;
        });
      ...
      value: function firstUpdated() {
        ...
        this.grid.render((_this$shadowRoot = this.shadowRoot) === null || _this$shadowRoot === void 0 ? void 0 : _this$shadowRoot.getElementById('js-canvas'));
      }
    }, {
      kind: "method",
      key: "render",
      value: function render() {
        ...
        return x$1` <div id="js-canvas"></div>`;
      }
    }]
  };
}, s$1);
